...
class CertificateValidator:
    ...
    @staticmethod
    def _validate_basic(cert: x509.Certificate) -> tuple[bool, str | None]:
    ...
    @staticmethod
    def _validate_dates(cert: x509.Certificate) -> tuple[bool, str | None]:
    ...
    @staticmethod
    def _validate_key_strength(cert: x509.Certificate) -> tuple[bool, str | None]:
    ...
    @staticmethod
    def _validate_key_usage(cert: x509.Certificate) -> tuple[bool, str | None]:
    ...
    @staticmethod
    def _validate_common_name(cert: x509.Certificate, required_cn: str) -> tuple[bool, str | None]:
    ...
    @staticmethod
    def _validate_chain(cert: x509.Certificate, ca_cert_pem: str) -> tuple[bool, str | None]:
    ...
    @staticmethod
    def _check_ocsp(cert: x509.Certificate, ocsp_url: str) -> tuple[bool | None, str | None]:
    ...
    @staticmethod
    def _check_crl(cert: x509.Certificate, crl_urls: list[str]) -> tuple[bool | None, str | None]:
