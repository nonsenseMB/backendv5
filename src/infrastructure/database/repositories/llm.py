...
class LLMProviderRepository(TenantAwareRepository[LLMProvider]):
    ...
    async def get_by_type(self, provider_type: str) -> LLMProvider | None:
    ...
    async def set_default_provider(self, provider_id: UUID) -> LLMProvider | None:
...
class LLMAPIKeyRepository(BaseRepository[LLMAPIKey]):
    ...
    async def get_active_key_for_provider(self, provider_id: UUID) -> LLMAPIKey | None:
    ...
    async def get_by_hint(self, key_hint: str) -> LLMAPIKey | None:
