...
async def test_complete_workflow():
    ...
    async for session in get_async_session():
        async with UnitOfWork(session) as uow:
            ...
            print("✓ Skipped vector memory creation (belongs in Milvus/Chroma, not PostgreSQL)")
            ...
            print("✓ Skipped memory sharing (handled by vector DB service, not PostgreSQL)")
            ...
            print("✓ Vector memories would be queried from vector DB (Milvus/Chroma)")
